...
import { ArrowLeft, Edit, Phone, Mail, MessageSquare, Building2, Landmark, Check, Plus, KeyRound, Clock, Briefcase, Award, GitBranch, MapPin, FileText, User, Calendar, X, Save } from "lucide-react";
                  ...
                  {isEditing ? (
                    <div style={{ marginTop: 10, display: "flex", flexDirection: "column" as const, gap: 8 }}>
                      ...
                      <div style={{ display: "flex", gap: 6, marginTop: 4 }}>
                        <Btn sm onClick={saveEdit} icon={Save}>Save</Btn>
